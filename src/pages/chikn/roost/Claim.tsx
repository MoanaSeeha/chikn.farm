    ...
    <div className='md:basis-1/3'>
      <Board className=''>
        ...
        <div className='flex flex-row border-b border-solid border-[#3b3d76] mt-12 justify-between pr-2 items-end'>
          <Tab titles={['Claim']} onChange={(i) => setTabState(i)} />
        ...
        <div className='px-3 py-7 text-center mx-auto space-y-5'>
          <div className='flex flex-col'>
            ...
            <div className='chikn-red text-base font-bold'>YOUR CLAIMABLE FEED</div>
          </div>
          <div className='flex flex-col my-6 mx-8 space-y-2'>
            <RoundedButton title='Claim'/>
            <RoundedButton title='claim and unstake all egg' onlyBorder/>
          </div>
        </div>
      </Board>
    </div>  
