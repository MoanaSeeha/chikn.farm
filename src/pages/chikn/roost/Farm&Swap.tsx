  ...
  return (
    <div className='md:basis-1/3'>
      <Board className=''>
        ...
        <div className='flex flex-row border-b border-solid border-[#3b3d76] mt-12 justify-between pr-2 items-end'>
          ...
          <div className='flex flex-row items-start text-right'>
            <div className=' space-x-2'>
              ...
              <div className='chikn-red text-xs font-bold'>TOTAL EGG HELD</div>
            </div>
